...
\]
Using moment generating functionals, Harris provided a criterion for when $q_\infty(x)<1$ for all $x$ or $q_\infty(x)=1$ for all $x$. This limit theorem requires the existence of mean field model satifying several technical assumptions. Typically, this mean field model with be the IPM 
