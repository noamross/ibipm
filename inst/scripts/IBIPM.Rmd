...
\]
Using moment generating functionals, Harris provided a criterion for when $q_\infty(x)<1$ for all $x$ or $q_\infty(x)=1$ for all $x$. Under suitable technical assumptions, this limit theorem implies that $q_\infty(x)=0$ for all $x$ whenever the dominant eigenvalue of the meanfield IPM is less than or equal to one, and $q_\infty(x)>0$ for all $x$, otherwise.  


### Sensitivity Formulas

**Need to decide whether this is worth doing**

## A Numerical Illustration

*I NEED TO UPDATE THE STUFF BELOW TO DEAL WITH THE SPECIFIC EXAMPLE AND ITS IMPLEMENTATION*
