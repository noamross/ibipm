...
We also used the data from $2001$ to see how extinction risk over different time frames depends on the size and composition of the population. Specifically, for different population sizes $N$, we randomly sampled $N$ individuals from the 2001 data and computed extinction risk of this sampled population over $5$ and $50$ year periods (Figure 4). For population size, we considered $500$ random samples of size $N$. Figure 4A illustrates that $\log$ extinction risk decreases, on average, linearly with the sample size and is, on average, greater for the $50$ year period than the $5$ year period. However, for smaller sample sizes, there is overlap in the distributions of extinction times for the $5$ and $50$ year time frames. This overlap stems from  samples of mostly large individuals being more likely to persist at least $50$ years than samples of mostly small individuals persisting at least $5$ years. Interestingly, variation in the extinction times across samples is consistently greater over the $5$ year period than the $50$ year period. Figure 4B illustrates that mean size of an individual within the population has a strong negative correlation with (log) extinction probability, and the slope of this correlation is steeper over shorter time frames than longer time frames.
