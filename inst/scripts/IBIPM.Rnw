...
<<IBIPM-plots2, fig.width=6, fig.height=4,echo=FALSE,fig.cap="Extinction probabilities for a population consisting of a single individual of size $x$. Different curves correspond to extinction in different number of years.">>=
T=100
out=Psi.iterate(T)
